...
**Q: I see `-cuda`, `-directml` and `-webgpu` installers. Do I need those?**
...
*The CUDA builds deliberately don't bundle the CUDA runtime. It's a multi-gigabyte install, and shipping it would make the download enormous.*
